...
# sites= ['ansa11', 'ansa16', 'ansa21', 'ansa26', 'jaakkoin61', 'jaakkoin62', 'koira11', 'koira12', 
#         'koira21', 'koira22', 'neva11', 'neva14', 'neva21', 'neva24', 'neva31', 'neva34', 'parkano11', 'parkano12']
...
BEFORE = False
if BEFORE:
    params = para(period='start-thin')
    folderName=r'C:/Users/alauren/OneDrive - University of Eastern Finland/Susi/susi_22_out/no_thin/'

else:
    params = para(period='thin-end')
    folderName=r'C:/Users/alauren/OneDrive - University of Eastern Finland/Susi/susi_22_out/thin/'



for s in params.keys():
    if params[s]['thinning']: 
        print ('************************************')
        print ('Now computing ', s)
        print ('************************************')
