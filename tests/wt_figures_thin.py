...
if BEFORE:
    ...
    sim_folder = r'C:/Users/alauren/OneDrive - University of Eastern Finland/Susi/susi_22_out/no_thin/'
else:
    params = para(period='thin-end')
    sim_folder = r'C:/Users/alauren/OneDrive - University of Eastern Finland/Susi/susi_22_out/thin/'
...
names = ['Koirasuo21','Koirasuo22',
         'Ansasaari11','Ansasaari16', 
         'Nevajärvi21','Nevajärvi24', 
         'Parkano12']
